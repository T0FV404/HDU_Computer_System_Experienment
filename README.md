...
```sh
git clone git@github.com:T0FV404/HDU_Compter_System_Experienment.git
cd HDU_Compter_System_Experienment
```
...
#### Commit your changes
```sh
git commit -m 'Starting HDU_Compter_System_Experienment'
...
```sh
./mill HDU_Compter_System_Experienment.test
```
